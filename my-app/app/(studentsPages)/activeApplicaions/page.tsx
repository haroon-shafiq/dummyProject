        ...
        <section className="w-full bg-[#F7FAFC] h-screen pt-5">
            <div className="max-w-[1440px] mx-[50px] h-full flex flex-col gap-4">
                ...
                <div className="flex justify-between gap-4">
                    ...
                    <button
                        className={`px-4 py-2 max-w-[110px] rounded-[12px] ${activeTab === "Applied" ? "bg-[#1A78E5] text-white" : "bg-[#E2E8F0] text-[#4F7096]"}`}
                        onClick={() => handleTabChange("Applied")}
                    >
                        Applied
                    </button>
                    <button
                        className={`px-4 py-2 max-w-[110px] text-[14px] rounded-[12px] ${activeTab === "Interviewing" ? "bg-[#1A78E5] text-white" : "bg-[#E2E8F0] text-[#4F7096]"}`}
                    ...
                    activeTab === "All" && (
                        <p className="text-[#4F7096] mt-4 text-center">
                            You have {applicationsData.length} active applications.
                        </p>
                    )
                }
